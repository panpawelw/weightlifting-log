...
(16, 'Token test name 8', '$2a$12$mIcDvX13BuHqyR1i205BKuKY.6mO8PJ1muMJJXZASHJYQhyYNHEGy', 'token@test8.com', 0, 'Test first name8', 'Test last name8', 8, 1, 'USER'),
(17, 'test', '$2a$12$QPV1B4XAm3SDYtdIydlQf.TSRz7NKQ1jtbEFAWQTdXhe2Xp.4mUji', 'test@email9.com', 0, 'Test first name9', 'Test last name9', 8, 1, 'USER');
