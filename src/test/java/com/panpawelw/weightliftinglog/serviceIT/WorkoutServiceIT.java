...
public class WorkoutServiceIT {
  ...
  public void findWorkoutByIdSucceeds() {
    WorkoutDeserialized testWorkout = service.findWorkoutById(1);
  ...
  public void findWorkoutByIdReturnsNull() {
    WorkoutDeserialized testWorkout = service.findWorkoutById(100);
  ...
  public void saveWorkoutSucceeds() {
    ...
    WorkoutDeserialized testWorkout = new WorkoutDeserialized(
        0L, "Test save workout title", java.sql.Timestamp.valueOf("2022-01-01 07:10:10.0"),
